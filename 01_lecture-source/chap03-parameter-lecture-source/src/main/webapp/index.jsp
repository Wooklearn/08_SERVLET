...
<body>
    ...
    <form action="querystring" method="get">
        ...
        <br>
        <label>성별 : </label><input type="radio" name="gender" id="male" value="M">
        ...
        <lavel for="movie">영화</lavel>
        <input type="checkbox" name="hobbies" id="music" value="music">
        <lavel for="music">음악</lavel>
        <input type="checkbox" name="hobbies" id="coding" value="coding">
        <lavel for="coding">코딩</lavel>
        <br>
        <input type="submit" value="GET 요청">
    </form>
    <h4>a 태그의 href 속성에 직접 데이터 넣어서 get 요청</h4>
    <a href="querystring?name=김용욱&age=20&birthday=2005-02-08&gender=M&national=ko&hobbies=music">
        쿼리스트링을 이용한 값 전달
    </a>
    ...
    <form action="formdata" method="post">
        ...
        <label>생일 : </label><input type="date" name="birthday">
        <br>
        <label>성별 : </label><input type="radio" name="gender" id="male2" value="M">
        <label for="male">남성</label>
